...
router.post('/register', [authLimiter,
  ...
  body('villageId').optional({ nullable: true }).isUUID(),
  body('rwNumber').optional({ nullable: true }).isInt({ min: 1, max: 100 }),
  body('rtNumber').optional({ nullable: true }).isInt({ min: 1, max: 100 }),
  validate,
], controller.register);
